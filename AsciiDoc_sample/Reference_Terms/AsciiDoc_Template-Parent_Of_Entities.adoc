...
[float]
=== See also
// Link relevant content by category, such as other Reference terms (please add the tag #SPRACHE#),
// definitions (please add the tag #DEFINITION#), and examples of Projects and Tutorials
// (please add the tag #BEISPIEL#)  ►►►►► THIS SECTION IS MANDATORY ◄◄◄◄◄
...
* #SPRACHE# link:../AsciiDoc_Template-Single_Entity[Single Entity]
* #SPRACHE# link:../../AsciiDoc_Dictionary/AsciiDoc_Template-Dictionary[AsciiDoc Template Dictionary]
