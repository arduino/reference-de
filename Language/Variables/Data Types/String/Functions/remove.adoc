...
[float]
=== Beschreibung
Ändert einen `String`, der die Zeichen aus dem angegebenen Index bis zum Ende des `String`s oder aus dem bereitgestellten Index entfernt, um die Anzahl der Indizes zu zählen.
