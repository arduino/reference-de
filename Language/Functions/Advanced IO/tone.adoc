...
[role="example"]
* #BEISPIEL# https://www.arduino.cc/en/Tutorial/BuiltInExamples/toneMelody[Töne^]
* #BEISPIEL# https://www.arduino.cc/en/Tutorial/tonePitchFollower[Tonleiter^]
* #BEISPIEL# https://www.arduino.cc/en/Tutorial/BuiltInExamples/toneKeyboard[Einfaches Keyboard^]
* #BEISPIEL# https://www.arduino.cc/en/Tutorial/BuiltInExamples/toneMultiple[Mehrere Töne^]
* #BEISPIEL# https://www.arduino.cc/en/Tutorial/PWM[PWM^]
