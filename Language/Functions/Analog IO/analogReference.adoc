...
Arduino mbed-fähige Boards (Nur Nano 33 BLE): Nur verfügbar, wenn die _Arduino mbed-fähige_-Plattform verwendet wird und nicht, wenn die _Arduino nRF528x Boards (Mbed OS)_-Plattform verwendet wird.
